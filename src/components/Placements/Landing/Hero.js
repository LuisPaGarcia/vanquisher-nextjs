...
function Hero() {
  const [toggleSolutions, toggleSolutionsSet] = useToggle();
  const [toggleMobileMenu, toggleMobileMenuSet] = useToggle();
  return (
    <>
            ...
            <div className="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
              ...
              <nav className="hidden md:flex space-x-10">
                <div className="relative">
                  <button
                    type="button"
                    className="group bg-white rounded-md active:text-gray-900 text-gray-500 inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    onClick={toggleSolutionsSet}
                  >
                    <span>Solutions</span>
                    <svg
                      className="ml-2 h-5 w-5 text-gray-400 group-hover:text-gray-500 active:text-gray-600"
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 20 20"
                      fill="currentColor"
                      aria-hidden="true"
                    ...
                    <div className="py-6 px-5">
                      ...
                      <div className="mt-6">
                        ...
                        <p className="mt-6 text-center text-base font-medium text-gray-500">
                          Existing customer?{" "}
                          <Link href="/api/login" className="text-gray-900">
                            Sign in
                          </Link>
                        </p>
                      </div>
